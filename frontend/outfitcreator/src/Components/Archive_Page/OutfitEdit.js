	...
	render() {
		...
		return (
			<div>
				...
				{/* ternary to check if modal is toggled or not
          this one will hold the content for screen, either the new 
							...
							<div className="container--edit">
								<CardDeck>
									...
									{items.map((item, index) => {
										return (
											<Card className="outfit--card" key={index} inverse>
												<CardImg
													key={item._id}
													width="80%"
													src={item.image}
								...
								<div className="container--editbox">
									<form>
										...
										<div className="edit--buttons">
											<button className="edit--submit button" onClick={this.submitChanges}>
												Submit
											</button>
											<button className="edit--cancel button" onClick={this.redirectArchive}>
												Cancel
											</button>
										</div>
									</form>
