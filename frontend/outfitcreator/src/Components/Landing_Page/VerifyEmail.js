...
class VerifyEmail extends Component {
    ...
    componentDidMount() {
        ...
        axios.post(`${ROOT_URL.API}/auth/verify`, { key })
        .then(() => {
    ...
    resendEmail = () => {
        ...
        axios.post(`${ROOT_URL.API}/auth/sendverifyemail`, { email })
            .then(() => {
        ...
        return (
            <div className="landingPage--login">
                ...
                {this.state.isLoading ? <Row>
                    ...
                    <ToastContainer />
                </Row> : (this.state.validated ? <Row>
                    <Col sm="12">
                        <Card body>
                            <CardText>Validation successful. Click <a href={`${ROOT_URL.WEB}/login/`}>here</a> to login</CardText>
                        </Card>
                    </Col>
                    <ToastContainer />
                </Row> :
                    ...
                    <Col sm="12">
                        ...
                        <form>
                            ...
                            <input 
                                ...
                                />
                            <Button className="button" onClick={this.resendEmail}>Click to resend email verification</Button>
                        </form>
                        </Card>
                    </Col>
                    <ToastContainer />
